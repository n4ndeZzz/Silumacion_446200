...
| **Prototipo funcional:** la experiencia puede ejecutarse y recorrerse completa sin errores que impidan comprenderla. | ⚠️ | El archivo no tiene errores de sintaxis y todas las funciones están conectadas y se llaman una sola vez. Confirmé en vivo que el movimiento, tamaño y desplazamiento por el mouse funcionan. Me falta confirmar visualmente en el navegador la repulsión añadida al final antes de darlo por 100% cerrado. |
